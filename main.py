...
if __name__ == '__main__':
    ...
    datasheet1 = arx.DataLoading_txt('VAR1.txt')
    datasheet2 = arx.DataLoading_txt('VAR3.txt')
    datasheet3 = arx.DataLoading_txt('VAR6.txt')
    datasheet4 = arx.DataLoading_txt('VAR9.txt')
    alpha = 0.05
